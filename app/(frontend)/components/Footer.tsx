...
const footerLinks = {
  ...
  resources: [
    ...
    { href: 'https://www.concordia.ca/ginacody/mechanical-industrial-aerospace-eng.html', label: 'MIE Department', external: true },
    { href: 'https://www.concordia.ca', label: 'Concordia University', external: true },
  ],
}
